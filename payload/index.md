...
| `RULE-coding.md` | `coding` | Contextual (high-sensitivity — default ON for any code work) | public | Philosophy, source-of-truth, verification (narrowest tool; app runs are user-triggered; runtime-only risk that can't run → "unverified" handoff, never a false "Done"), error handling, security |
